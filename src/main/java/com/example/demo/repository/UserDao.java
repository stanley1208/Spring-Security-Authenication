...
public class UserDao {
	...
	public Map<String, Map<String, String>>users;
	{
		...
		info1.put("password", "$2a$10$TrgQ4ZDsiLWmF21dmO1kUuzlnIf72wSpm95WUtExjd8StL3yDHW1u");
		info1.put("authority", ",normal,ROLE_manager");
		// A02, 5678, admin
		Map<String, String>info2=new LinkedHashMap<>();
		info2.put("password", "$2a$10$k2d3Mo9kOu0P8ooX1rAFNeA3Hyk8R7H5aZxd1QBqoXds4F1rppH..");
